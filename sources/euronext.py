...
#        q1.start()
        ...
        sql="select isin from investments, quotes where quotes.code=investments.code and quotes.code like 'EURONEXT#%' and isin is not null and quotes.date='"+yesterday+"' and last<>'close' order by isin;"
