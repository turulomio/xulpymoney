...
def index(req):
    def page():
        ...
        s=s+'    var url="ajax/cuentaoperacion_insertar.py?fecha="+fecha+"&id_conceptos="+id_conceptos+"&id_tiposoperaciones="+id_tiposoperaciones+"&importe="+importe+"&comentario="+comentario+"&id_cuentas="+id_cuentas;\n'
