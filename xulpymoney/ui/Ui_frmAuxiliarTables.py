...
class Ui_frmAuxiliarTables(object):
    def setupUi(self, frmAuxiliarTables):
        ...
        self.tabconcepts = QtWidgets.QWidget()
        self.tabconcepts.setObjectName("tabconcepts")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.tabconcepts)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout()
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.mqtwConcepts = mqtwObjects(self.tabconcepts)
        self.mqtwConcepts.setObjectName("mqtwConcepts")
        self.verticalLayout_2.addWidget(self.mqtwConcepts)
        self.horizontalLayout_2.addLayout(self.verticalLayout_2)
        self.tabWidget.addTab(self.tabconcepts, "")
    ...
    def retranslateUi(self, frmAuxiliarTables):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabconcepts), _translate("frmAuxiliarTables", "Xulpymoney concepts"))
