...
class Ui_wdgProductsComparation(object):
    def setupUi(self, wdgProductsComparation):
        ...
        self.cmdPairsDeete = QtWidgets.QToolButton(wdgProductsComparation)
        self.cmdPairsDeete.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/xulpymoney/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cmdPairsDeete.setIcon(icon1)
        self.cmdPairsDeete.setObjectName("cmdPairsDeete")
        self.horizontalLayout_6.addWidget(self.cmdPairsDeete)
