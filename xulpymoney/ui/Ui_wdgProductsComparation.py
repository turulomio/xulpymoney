...
class Ui_wdgProductsComparation(object):
    def setupUi(self, wdgProductsComparation):
        ...
        wdgProductsComparation.resize(1064, 520)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(wdgProductsComparation)
        ...
        self.horizontalLayout_2.addWidget(self.cmdSwap)
        ...
        self.cmbCompareTypes.addItem(icon2, "")
        self.cmbCompareTypes.addItem(icon1, "")
        self.horizontalLayout_2.addWidget(self.cmbCompareTypes)
        ...
        self.cmbDateSelector.addItem("")
        self.cmbDateSelector.addItem("")
        self.verticalLayout.addWidget(self.cmbDateSelector)
        ...
        self.verticalLayout.addWidget(self.deCompare)
        ...
        self.horizontalLayout_2.addWidget(self.cmdComparationData)
        ...
        self.horizontalLayout_2.addWidget(self.cmdComparation)
