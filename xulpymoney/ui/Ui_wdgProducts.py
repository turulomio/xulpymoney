...
# Form implementation generated from reading ui file 'ui/wdgProducts.ui'
#
...
class Ui_wdgProducts(object):
    def setupUi(self, wdgProducts):
        ...
        self.verticalLayout_2.addWidget(self.tblInvestments)
        ...
        self.chkStockExchange.toggled['bool'].connect(self.label_2.setEnabled)
    ...
    def retranslateUi(self, wdgProducts):
        ...
        self.label_2.setText(_translate("wdgProducts", "Filter by stock exchange"))
