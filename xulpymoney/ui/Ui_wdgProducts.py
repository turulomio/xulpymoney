...
class Ui_wdgProducts(object):
    def setupUi(self, wdgProducts):
        ...
        self.chkObsolete = QtWidgets.QCheckBox(self.groupBox)
        self.chkObsolete.setObjectName("chkObsolete")
        self.verticalLayout.addWidget(self.chkObsolete)
    ...
    def retranslateUi(self, wdgProducts):
        ...
        self.chkObsolete.setText(_translate("wdgProducts", "Show obsolete products"))
