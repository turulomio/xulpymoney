...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon49 = QtGui.QIcon()
        icon49.addPixmap(QtGui.QPixmap(":/xulpymoney/investing_com.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuoteImportInvestingComIntraday.setIcon(icon49)
