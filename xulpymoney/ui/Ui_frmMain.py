...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        self.tlbProducts = QtWidgets.QToolBar(frmMain)
        self.tlbProducts.setObjectName("tlbProducts")
        frmMain.addToolBar(QtCore.Qt.TopToolBarArea, self.tlbProducts)
        ...
        self.actionOrders.setIcon(icon27)
        ...
        self.actionPurchaseOpportunities.setIcon(icon40)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/xulpymoney/cloud_download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProductsUpdate.setIcon(icon42)
        ...
        self.toolBar.addAction(self.actionPurchaseOpportunities)
        self.toolBar.addSeparator()
        ...
        self.toolBar.addAction(self.actionDividendsReport)
        self.toolBar.addAction(self.actionInvestmentsClasses)
        self.toolBar.addAction(self.actionTotalReport)
        self.toolBar.addAction(self.actionInvestmentRanking)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionCalculator)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionSettings)
        self.toolBar.addAction(self.actionExit)
        self.tlbProducts.addAction(self.actionFavorites)
        self.tlbProducts.addAction(self.actionIndexesAll)
        self.tlbProducts.addAction(self.actionSearch)
        self.tlbProducts.addSeparator()
        self.tlbProducts.addAction(self.actionProductsComparation)
        self.tlbProducts.addSeparator()
        self.tlbProducts.addAction(self.actionPriceUpdates)
        self.tlbProducts.addAction(self.actionSyncProducts)
        self.tlbProducts.addAction(self.actionProductsUpdate)
    ...
    def retranslateUi(self, frmMain):
        ...
        self.tlbProducts.setWindowTitle(_translate("frmMain", "Products toolbar"))
