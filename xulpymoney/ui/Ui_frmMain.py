...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/xulpymoney/compare.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProductsComparation.setIcon(icon41)
    ...
    def retranslateUi(self, frmMain):
        ...
        self.actionProductsComparation.setText(_translate("frmMain", "Compare pro&ducts"))
