...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon44 = QtGui.QIcon()
        icon44.addPixmap(QtGui.QPixmap(":/xulpymoney/dialog-ok-apply.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProductsInvalidISIN.setIcon(icon44)
        ...
        icon45 = QtGui.QIcon()
        icon45.addPixmap(QtGui.QPixmap(":/xulpymoney/compare.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProductsComparation.setIcon(icon45)
        self.actionProductsComparation.setObjectName("actionProductsComparation")
        self.actionShowBenchmark = QtWidgets.QAction(frmMain)
        icon46 = QtGui.QIcon()
        icon46.addPixmap(QtGui.QPixmap(":/xulpymoney/benchmark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowBenchmark.setIcon(icon46)
        self.actionShowBenchmark.setObjectName("actionShowBenchmark")
        self.actionInvestmentsZeroRisk = QtWidgets.QAction(frmMain)
        icon47 = QtGui.QIcon()
        icon47.addPixmap(QtGui.QPixmap(":/xulpymoney/zerorisk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInvestmentsZeroRisk.setIcon(icon47)
        ...
        icon48 = QtGui.QIcon()
        icon48.addPixmap(QtGui.QPixmap(":/xulpymoney/investing_com.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuoteImportInvestingComIntraday.setIcon(icon48)
        ...
        self.actionReportIssue.setIcon(icon41)
