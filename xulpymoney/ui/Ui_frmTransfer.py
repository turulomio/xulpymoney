...
class Ui_frmTransfer(object):
    def setupUi(self, frmTransfer):
        ...
        self.txtamount = myQLineEdit(frmTransfer)
        ...
        self.horizontalLayout.addWidget(self.txtamount)
    ...
    def retranslateUi(self, frmTransfer):
        ...
        self.txtamount.setToolTip(_translate("frmTransfer", "Amount must be positive"))
        self.txtamount.setText(_translate("frmTransfer", "0"))
