...
# Form implementation generated from reading ui file 'xulpymoney/ui/frmInvestmentHlReport.ui'
#
...
class Ui_frmInvestmentHlReport(object):
    def setupUi(self, frmInvestmentHlReport):
        frmInvestmentHlReport.setObjectName("frmInvestmentHlReport")
        frmInvestmentHlReport.setWindowModality(QtCore.Qt.WindowModal)
        frmInvestmentHlReport.resize(716, 539)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/xulpymoney/report2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        frmInvestmentHlReport.setWindowIcon(icon)
        frmInvestmentHlReport.setModal(True)
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(frmInvestmentHlReport)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.lblTitulo = QtWidgets.QLabel(frmInvestmentHlReport)
        font = QtGui.QFont()
        ...
        self.tab = QtWidgets.QTabWidget(frmInvestmentHlReport)
        ...
        self.actionOperationAdd = QtWidgets.QAction(frmInvestmentHlReport)
        icon8 = QtGui.QIcon()
        ...
        self.actionOperationDelete = QtWidgets.QAction(frmInvestmentHlReport)
        icon9 = QtGui.QIcon()
        ...
        self.actionDividendAdd = QtWidgets.QAction(frmInvestmentHlReport)
        self.actionDividendAdd.setIcon(icon8)
        self.actionDividendAdd.setObjectName("actionDividendAdd")
        self.actionDividendRemove = QtWidgets.QAction(frmInvestmentHlReport)
        self.actionDividendRemove.setIcon(icon9)
        self.actionDividendRemove.setObjectName("actionDividendRemove")
        self.actionOperationEdit = QtWidgets.QAction(frmInvestmentHlReport)
        icon10 = QtGui.QIcon()
        ...
        self.actionDisReinvestProduct = QtWidgets.QAction(frmInvestmentHlReport)
        icon13 = QtGui.QIcon()
        ...
        self.retranslateUi(frmInvestmentHlReport)
        self.tab.setCurrentIndex(4)
        self.chkExpiration.toggled['bool'].connect(self.calExpiration.setEnabled)
        QtCore.QMetaObject.connectSlotsByName(frmInvestmentHlReport)

    def retranslateUi(self, frmInvestmentHlReport):
        _translate = QtCore.QCoreApplication.translate
        frmInvestmentHlReport.setWindowTitle(_translate("frmInvestmentHlReport", "Investment report"))
        self.label.setText(_translate("frmInvestmentHlReport", "Associated account"))
        self.label_2.setText(_translate("frmInvestmentHlReport", "Investment name"))
        self.txtInvestment.setText(_translate("frmInvestmentHlReport", "New investment"))
        self.label_4.setText(_translate("frmInvestmentHlReport", "Selling price"))
        self.txtVenta.setText(_translate("frmInvestmentHlReport", "0"))
        self.chkExpiration.setText(_translate("frmInvestmentHlReport", "Add selling order expiration"))
        self.cmdToday.setToolTip(_translate("frmInvestmentHlReport", "Change calendar date to today"))
        self.cmdInvestment.setText(_translate("frmInvestmentHlReport", "Update investment"))
        self.tab.setTabText(self.tab.indexOf(self.tab_12), _translate("frmInvestmentHlReport", "Investment data"))
        self.grpCurrentInvestmentCurrency.setTitle(_translate("frmInvestmentHlReport", "Current status in investment currency"))
        self.grpCurrentAccountCurrency.setTitle(_translate("frmInvestmentHlReport", "Current status in account currency"))
        self.tab.setTabText(self.tab.indexOf(self.tabInvestmentCurrent), _translate("frmInvestmentHlReport", "Current status"))
        self.chkOperaciones.setText(_translate("frmInvestmentHlReport", "Show all operations"))
        self.grpOperationsInvestmentCurrency.setTitle(_translate("frmInvestmentHlReport", "Operations in investment currency"))
        self.grpOperationsAccountCurrency.setTitle(_translate("frmInvestmentHlReport", "Operations in account currency"))
        self.tab.setTabText(self.tab.indexOf(self.tabOperacionesHistoricas), _translate("frmInvestmentHlReport", "Operations"))
        self.grpHistoricalInvestmentCurrency.setTitle(_translate("frmInvestmentHlReport", "Historical operations in investment currency"))
        self.grpHistoricalAccountCurrency.setTitle(_translate("frmInvestmentHlReport", "Historical operations in account currency"))
        self.tab.setTabText(self.tab.indexOf(self.tab_2), _translate("frmInvestmentHlReport", "Historical operations"))
        self.chkHistoricalDividends.setText(_translate("frmInvestmentHlReport", "Show historical dividends"))
        self.grpDividendsInvestmentCurrency.setTitle(_translate("frmInvestmentHlReport", "Dividends in investment currency"))
        self.grpDividendsAccountCurrency.setTitle(_translate("frmInvestmentHlReport", "Dividends in account currency"))
        self.grpDividendsEstimation.setTitle(_translate("frmInvestmentHlReport", "Estimation"))
        self.lblDivAnualEstimado.setText(_translate("frmInvestmentHlReport", "APR"))
        self.lblDivFechaRevision.setText(_translate("frmInvestmentHlReport", "Review date"))
        self.lblDivSaldoEstimado.setText(_translate("frmInvestmentHlReport", "Estimated balance"))
        self.grpDividendsEfectivos.setTitle(_translate("frmInvestmentHlReport", "Collected dividends"))
        self.lblDivTPC.setText(_translate("frmInvestmentHlReport", "% Invested"))
        self.lblDivTAE.setText(_translate("frmInvestmentHlReport", "% APR"))
        self.tab.setTabText(self.tab.indexOf(self.tabDividends), _translate("frmInvestmentHlReport", "Dividends"))
        self.actionOperationAdd.setText(_translate("frmInvestmentHlReport", "New operation"))
        self.actionOperationAdd.setToolTip(_translate("frmInvestmentHlReport", "New operation"))
        self.actionOperationDelete.setText(_translate("frmInvestmentHlReport", "Delete operation"))
        self.actionOperationDelete.setToolTip(_translate("frmInvestmentHlReport", "Delete operation"))
        self.actionDividendAdd.setText(_translate("frmInvestmentHlReport", "Add new dividend"))
        self.actionDividendAdd.setToolTip(_translate("frmInvestmentHlReport", "Add new dividend"))
        self.actionDividendRemove.setText(_translate("frmInvestmentHlReport", "Delete dividend"))
        self.actionDividendRemove.setToolTip(_translate("frmInvestmentHlReport", "Delete dividend"))
        self.actionOperationEdit.setText(_translate("frmInvestmentHlReport", "Edit operation"))
        self.actionOperationEdit.setToolTip(_translate("frmInvestmentHlReport", "Edit operation"))
        self.actionDisReinvest.setText(_translate("frmInvestmentHlReport", "Disinvest / Reinvest report"))
        self.actionDisReinvest.setToolTip(_translate("frmInvestmentHlReport", "Disinvest / Reinvest report"))
        self.actionSellingPoint.setText(_translate("frmInvestmentHlReport", "Selling point calculation"))
        self.actionSellingPoint.setToolTip(_translate("frmInvestmentHlReport", "Selling point calculation"))
        self.actionDividendEdit.setText(_translate("frmInvestmentHlReport", "Edit dividend"))
        self.actionDividendEdit.setToolTip(_translate("frmInvestmentHlReport", "Edit dividend"))
        self.actionSharesTransferUndo.setText(_translate("frmInvestmentHlReport", "Undo shares transfer to another bank"))
        self.actionSharesTransferUndo.setToolTip(_translate("frmInvestmentHlReport", "Undo shares transfer to another bank"))
        self.actionSharesTransfer.setText(_translate("frmInvestmentHlReport", "Transfer shares to another bank"))
        self.actionSharesTransfer.setToolTip(_translate("frmInvestmentHlReport", "Transfer shares to another bank"))
        self.actionSplit.setText(_translate("frmInvestmentHlReport", "Make Split / Contrasplit"))
        self.actionSplit.setToolTip(_translate("frmInvestmentHlReport", "make Split / Contrasplit"))
        self.actionChangeBenchmarkPrice.setText(_translate("frmInvestmentHlReport", "Change benchmark price"))
        self.actionChangeBenchmarkPrice.setToolTip(_translate("frmInvestmentHlReport", "Change benchmark price"))
        self.actionRangeReport.setText(_translate("frmInvestmentHlReport", "Hide in range report"))
        self.actionRangeReport.setToolTip(_translate("frmInvestmentHlReport", "Hide in range report"))
        self.actionDisReinvestProduct.setText(_translate("frmInvestmentHlReport", "Disinvest / Reinvest all product"))
        self.actionDisReinvestProduct.setToolTip(_translate("frmInvestmentHlReport", "Disinvest / Reinvest all product"))
