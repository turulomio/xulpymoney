...
class Ui_wdgDisReinvest(object):
    def setupUi(self, wdgDisReinvest):
        ...
        self.tblHistoricalOps = QtWidgets.QTabWidget(self.tab_10)
        ...
        self.tblHistoricalOps.addTab(self.tab_13, "")
        ...
        self.tblHistoricalOps.addTab(self.Situac_3, "")
        self.tab_14 = QtWidgets.QWidget()
        self.tab_14.setObjectName("tab_14")
        self.horizontalLayout_27 = QtWidgets.QHBoxLayout(self.tab_14)
        self.horizontalLayout_27.setObjectName("horizontalLayout_27")
        self.tblInvestmentsHistoricas_2 = myQTableWidget(self.tab_14)
        self.tblInvestmentsHistoricas_2.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tblInvestmentsHistoricas_2.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tblInvestmentsHistoricas_2.setAlternatingRowColors(True)
        self.tblInvestmentsHistoricas_2.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.tblInvestmentsHistoricas_2.setObjectName("tblInvestmentsHistoricas_2")
        self.tblInvestmentsHistoricas_2.setColumnCount(11)
        self.tblInvestmentsHistoricas_2.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblInvestmentsHistoricas_2.setHorizontalHeaderItem(10, item)
        self.tblInvestmentsHistoricas_2.verticalHeader().setVisible(False)
        self.horizontalLayout_27.addWidget(self.tblInvestmentsHistoricas_2)
        self.tblHistoricalOps.addTab(self.tab_14, "")
        self.horizontalLayout_29.addWidget(self.tblHistoricalOps)
        self.tabAB.addTab(self.tab_10, "")
        ...
        self.tblHistoricalOps.setCurrentIndex(2)
        self.tabOpAcHi.setCurrentIndex(3)
    ...
    def retranslateUi(self, wdgDisReinvest):
        ...
        self.tblHistoricalOps.setTabText(self.tblHistoricalOps.indexOf(self.tab_13), _translate("wdgDisReinvest", "Investment operations"))
        ...
        self.tblHistoricalOps.setTabText(self.tblHistoricalOps.indexOf(self.Situac_3), _translate("wdgDisReinvest", "Investment current state"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(0)
        item.setText(_translate("wdgDisReinvest", "Date"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(1)
        item.setText(_translate("wdgDisReinvest", "Years"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(2)
        item.setText(_translate("wdgDisReinvest", "Investment"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(3)
        item.setText(_translate("wdgDisReinvest", "Operation type"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(4)
        item.setText(_translate("wdgDisReinvest", "Initial balance"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(5)
        item.setText(_translate("wdgDisReinvest", "Final balance"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(6)
        item.setText(_translate("wdgDisReinvest", "Gross"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(7)
        item.setText(_translate("wdgDisReinvest", "Comissions"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(8)
        item.setText(_translate("wdgDisReinvest", "Taxes"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(9)
        item.setText(_translate("wdgDisReinvest", "Net"))
        item = self.tblInvestmentsHistoricas_2.horizontalHeaderItem(10)
        item.setText(_translate("wdgDisReinvest", "% Total"))
        self.tblHistoricalOps.setTabText(self.tblHistoricalOps.indexOf(self.tab_14), _translate("wdgDisReinvest", "Historical operations"))
        self.tabAB.setTabText(self.tabAB.indexOf(self.tab_10), _translate("wdgDisReinvest", "New"))
