...
class Ui_wdgDisReinvest(object):
    def setupUi(self, wdgDisReinvest):
        ...
        self.tblHistoricalOps = myQTableWidget(self.tab_14)
        ...
        self.tblHistoricalOps.setColumnCount(11)
        self.tblHistoricalOps.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblHistoricalOps.setHorizontalHeaderItem(10, item)
        self.tblHistoricalOps.verticalHeader().setVisible(False)
        self.horizontalLayout_27.addWidget(self.tblHistoricalOps)
        self.tabOps.addTab(self.tab_14, "")
    ...
    def retranslateUi(self, wdgDisReinvest):
        ...
        item = self.tblHistoricalOps.horizontalHeaderItem(0)
        item.setText(_translate("wdgDisReinvest", "Date"))
        item = self.tblHistoricalOps.horizontalHeaderItem(1)
        item.setText(_translate("wdgDisReinvest", "Years"))
        item = self.tblHistoricalOps.horizontalHeaderItem(2)
        item.setText(_translate("wdgDisReinvest", "Investment"))
        item = self.tblHistoricalOps.horizontalHeaderItem(3)
        item.setText(_translate("wdgDisReinvest", "Operation type"))
        item = self.tblHistoricalOps.horizontalHeaderItem(4)
        item.setText(_translate("wdgDisReinvest", "Initial balance"))
        item = self.tblHistoricalOps.horizontalHeaderItem(5)
        item.setText(_translate("wdgDisReinvest", "Final balance"))
        item = self.tblHistoricalOps.horizontalHeaderItem(6)
        item.setText(_translate("wdgDisReinvest", "Gross"))
        item = self.tblHistoricalOps.horizontalHeaderItem(7)
        item.setText(_translate("wdgDisReinvest", "Comissions"))
        item = self.tblHistoricalOps.horizontalHeaderItem(8)
        item.setText(_translate("wdgDisReinvest", "Taxes"))
        item = self.tblHistoricalOps.horizontalHeaderItem(9)
        item.setText(_translate("wdgDisReinvest", "Net"))
        item = self.tblHistoricalOps.horizontalHeaderItem(10)
        item.setText(_translate("wdgDisReinvest", "% Total"))
        self.tabOps.setTabText(self.tabOps.indexOf(self.tab_14), _translate("wdgDisReinvest", "Historical operations"))
