...
class Ui_frmAccountsReport(object):
    def setupUi(self, frmAccountsReport):
        ...
        self.mqtwOperations = myQTableWidget(self.groupBox_2)
        ...
        self.mqtwCreditCards = myQTableWidget(self.groupBox_3)
        ...
        self.mqtwCreditCardOperations = myQTableWidget(self.grpOperTarjetas)
        ...
        self.tblCreditCardOpers = QtWidgets.QTableWidget(self.grpOperTarjetas)
        ...
        self.mqtwCreditCardOperationsHistorical = myQTableWidget(self.tab_3)
        ...
        self.tabOpertarjetasDiferidas.setCurrentIndex(1)
