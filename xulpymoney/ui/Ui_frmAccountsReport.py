...
class Ui_frmAccountsReport(object):
    def setupUi(self, frmAccountsReport):
        ...
        frmAccountsReport.resize(813, 607)
        icon = QtGui.QIcon()
        ...
        self.tblOperaciones = myQTableWidget(self.groupBox_2)
        self.tblOperaciones.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tblOperaciones.setAlternatingRowColors(True)
        self.tblOperaciones.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tblOperaciones.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tblOperaciones.setObjectName("tblOperaciones")
        self.tblOperaciones.setColumnCount(6)
        ...
        self.tblOperaciones.horizontalHeader().setStretchLastSection(True)
        self.tblOperaciones.verticalHeader().setVisible(False)
        self.tblOperaciones.verticalHeader().setStretchLastSection(False)
        self.verticalLayout_3.addWidget(self.tblOperaciones)
        ...
        self.tblCreditCards = myQTableWidget(self.groupBox_3)
        self.tblCreditCards.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tblCreditCards.setAlternatingRowColors(True)
        self.tblCreditCards.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tblCreditCards.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tblCreditCards.setObjectName("tblCreditCards")
        self.tblCreditCards.setColumnCount(6)
        self.tblCreditCards.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCards.setHorizontalHeaderItem(5, item)
        self.tblCreditCards.verticalHeader().setVisible(False)
        self.verticalLayout_4.addWidget(self.tblCreditCards)
        ...
        self.tblCreditCardOpers = myQTableWidget(self.grpOperTarjetas)
        self.tblCreditCardOpers.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tblCreditCardOpers.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tblCreditCardOpers.setAlternatingRowColors(True)
        self.tblCreditCardOpers.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.tblCreditCardOpers.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tblCreditCardOpers.setObjectName("tblCreditCardOpers")
        self.tblCreditCardOpers.setColumnCount(4)
        self.tblCreditCardOpers.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCardOpers.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCardOpers.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCardOpers.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblCreditCardOpers.setHorizontalHeaderItem(3, item)
        self.tblCreditCardOpers.verticalHeader().setVisible(False)
        self.verticalLayout_7.addWidget(self.tblCreditCardOpers)
        ...
        self.grpPago.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.tblOpertarjetasHistoricas = myQTableWidget(self.tab_3)
        self.tblOpertarjetasHistoricas.setAlternatingRowColors(True)
        self.tblOpertarjetasHistoricas.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tblOpertarjetasHistoricas.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tblOpertarjetasHistoricas.setObjectName("tblOpertarjetasHistoricas")
        self.tblOpertarjetasHistoricas.setColumnCount(0)
        self.tblOpertarjetasHistoricas.setRowCount(0)
        self.tblOpertarjetasHistoricas.verticalHeader().setVisible(False)
        self.verticalLayout_9.addWidget(self.tblOpertarjetasHistoricas)
    ...
    def retranslateUi(self, frmAccountsReport):
        ...
        item.setText(_translate("frmAccountsReport", "Date"))
        item = self.tblOperaciones.horizontalHeaderItem(1)
        item.setText(_translate("frmAccountsReport", "Concept"))
        item = self.tblOperaciones.horizontalHeaderItem(2)
        item.setText(_translate("frmAccountsReport", "Amount"))
        item = self.tblOperaciones.horizontalHeaderItem(3)
        item.setText(_translate("frmAccountsReport", "Balance"))
        item = self.tblOperaciones.horizontalHeaderItem(4)
        item.setText(_translate("frmAccountsReport", "Comment"))
        item = self.tblOperaciones.horizontalHeaderItem(5)
        item.setText(_translate("frmAccountsReport", "Id"))
        ...
        item = self.tblCreditCards.horizontalHeaderItem(0)
        item.setText(_translate("frmAccountsReport", "Credit card"))
        item = self.tblCreditCards.horizontalHeaderItem(1)
        item.setText(_translate("frmAccountsReport", "Number"))
        item = self.tblCreditCards.horizontalHeaderItem(2)
        item.setText(_translate("frmAccountsReport", "Active"))
        item = self.tblCreditCards.horizontalHeaderItem(3)
        item.setText(_translate("frmAccountsReport", "Delayed payment"))
        item = self.tblCreditCards.horizontalHeaderItem(4)
        item.setText(_translate("frmAccountsReport", "Maximum balance"))
        item = self.tblCreditCards.horizontalHeaderItem(5)
        item.setText(_translate("frmAccountsReport", "Balance"))
        self.grpOperTarjetas.setTitle(_translate("frmAccountsReport", "Selected Credit Card delayed operations"))
        item = self.tblCreditCardOpers.horizontalHeaderItem(0)
        item.setText(_translate("frmAccountsReport", "Date"))
        item = self.tblCreditCardOpers.horizontalHeaderItem(1)
        item.setText(_translate("frmAccountsReport", "Concept"))
        item = self.tblCreditCardOpers.horizontalHeaderItem(2)
        item.setText(_translate("frmAccountsReport", "Amount"))
        item = self.tblCreditCardOpers.horizontalHeaderItem(3)
        item.setText(_translate("frmAccountsReport", "Comment"))
