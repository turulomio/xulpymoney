...
# Form implementation generated from reading ui file 'ui/wdgCalculator.ui'
#
...
class Ui_wdgCalculator(object):
    def setupUi(self, wdgCalculator):
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.cmbPrice)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.txtProductPrice)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.spnProductPriceVariation)
        self.lblLeveraged = QtWidgets.QLabel(self.groupBox)
        self.lblLeveraged.setObjectName("lblLeveraged")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.lblLeveraged)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.txtLeveraged)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.txtFinalPrice)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cmbInvestments)
        ...
        self.table = myQTableWidget(self.groupBox_3)
    ...
    def retranslateUi(self, wdgCalculator):
        ...
        self.label_6.setText(_translate("wdgCalculator", "Final price"))
        self.groupBox_2.setTitle(_translate("wdgCalculator", "Shares calc"))
        self.label_4.setText(_translate("wdgCalculator", "Amount to invest"))
        self.label_5.setText(_translate("wdgCalculator", "Shares"))
        ...
        item.setText(_translate("wdgCalculator", "Price"))
