...
class Ui_wdgProductRange(object):
    def setupUi(self, wdgProductRange):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/xulpymoney/star.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/xulpymoney/order.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOrderAdd.setIcon(icon4)
        self.actionOrderAdd.setObjectName("actionOrderAdd")
        self.actionInvestmentMergingCurrent = QtWidgets.QAction(wdgProductRange)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/xulpymoney/investment.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInvestmentMergingCurrent.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/xulpymoney/gafas.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRangeInformation.setIcon(icon6)
    ...
    def retranslateUi(self, wdgProductRange):
        ...
        self.cmbRecomendations.setItemText(0, _translate("wdgProductRange", "All ranges"))
        self.cmbRecomendations.setItemText(1, _translate("wdgProductRange", "Three simple movil average"))
        self.cmbRecomendations.setItemText(2, _translate("wdgProductRange", "Over simple movil average 100"))
