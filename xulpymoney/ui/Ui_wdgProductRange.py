...
class Ui_wdgProductRange(object):
    def setupUi(self, wdgProductRange):
        ...
        wdgProductRange.resize(747, 519)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(wdgProductRange)
        ...
        self.cmbBenchmarkCurrent = QtWidgets.QComboBox(wdgProductRange)
        ...
        self.cmdIRAnalisis = QtWidgets.QToolButton(wdgProductRange)
        icon = QtGui.QIcon()
        ...
        self.cmdIRInsertar = QtWidgets.QToolButton(wdgProductRange)
        icon1 = QtGui.QIcon()
        ...
        self.cmbShowOptions = QtWidgets.QComboBox(wdgProductRange)
    ...
    def retranslateUi(self, wdgProductRange):
        ...
        self.groupBox.setTitle(_translate("wdgProductRange", "Report data"))
        self.label_2.setText(_translate("wdgProductRange", "Percentage between ranges"))
        self.spin.setSuffix(_translate("wdgProductRange", " %"))
        self.label.setText(_translate("wdgProductRange", "Money to invest"))
        self.txtInvertir.setText(_translate("wdgProductRange", "4000"))
        self.label_4.setText(_translate("wdgProductRange", "Index lowest limit"))
        self.txtMinimo.setText(_translate("wdgProductRange", "1000"))
        ...
        self.cmbShowOptions.setItemText(0, _translate("wdgProductRange", "Marked to show investment operations"))
        self.cmbShowOptions.setItemText(1, _translate("wdgProductRange", "Show ETF, Shares and Warrants Investment operations"))
