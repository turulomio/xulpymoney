...
class Ui_wdgProductRange(object):
    ...
    def retranslateUi(self, wdgProductRange):
        ...
        self.chkOnlyFirst.setText(_translate("wdgProductRange", "Show only first investment operation"))
        self.chkOnlyAccount.setText(_translate("wdgProductRange", "Show only from an account"))
