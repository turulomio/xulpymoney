...
class Ui_wdgProductRange(object):
    def setupUi(self, wdgProductRange):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/xulpymoney/order.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOrderAdd.setIcon(icon2)
        ...
        self.actionInvestmentMergingCurrent.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/xulpymoney/gafas.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRangeInformation.setIcon(icon4)
