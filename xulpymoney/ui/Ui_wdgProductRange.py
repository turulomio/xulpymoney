...
class Ui_wdgProductRange(object):
    def setupUi(self, wdgProductRange):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/xulpymoney/investment.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInvestmentMergingCurrent.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/xulpymoney/gafas.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRangeInformation.setIcon(icon5)
