...
class Inversion:
    ...
    def nombre_tpcvariable(self,  tpcvariable):
        ...
        if tpcvariable==50:
            return _("P. Pensiones e inversiones hasta un %s en renta variable, fondos alternativos y renta fija") % "50 %"
        if tpcvariable==100:
            return _("P. Pensiones e inversiones hasta un %s en renta variable y acciones") % "100 %"
        return None
    ...
    def xul_listado(self, sql):
        ...
        s= s+  '        <treecol id="id" label="id" hidden="true" />\n'
        s= s+  '        <treecol id="activa" label="'+_('activa')+'" hidden="true" />\n'
        s= s+  '        <treecol id="inversion" label="'+_('Inversión')+'" sort="?inversion" sortActive="true" sortDirection="descending" flex="2"/>\n'
        s= s+  '        <treecol id="col_entidad_bancaria" label="'+_('Entidad Bancaria')+'"  flex="2"/>\n'
        ...
        s= s+  '        <treecol id="col_saldo" label="'+_('Pendiente')+'" flex="1" style="text-align: right"/>\n'
        s= s+  '        <treecol label="'+_('Invertido')+'" hidden="true"  flex="1" style="text-align: right" />\n'
        s= s+  '        <treecol id="rendimiento" label="'+_('Rendimiento')+'"   sortActive="true" sortDirection="descending" flex="1" style="text-align: right"/>\n'
        s= s+  '    </treecols>\n'
        s= s+  '    <treechildren>\n'
        while not curs.EOF:
            row = curs.GetRowAssoc(0)   
