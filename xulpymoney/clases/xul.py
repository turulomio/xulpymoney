...
def menu():
    ...
    s=s +  '            <menuitem label="'+_('Histórico')+'" onclick="location=\'inversion_historico.py\';" class="menuitem-iconic" image="images/history.png" />\n'
    s= s+ '        <menuseparator/>\n'
    ...
    s=s +  '         <menupopup>\n'
    s=s +  '            <menuitem label="'+_('Clasificación')+'" onclick="location=\'inversion_clasificacion.py\';"  class="menuitem-iconic" image="images/cakes.png" />\n'
    ...
    s=s +  '            <menuitem label="'+_('Evolución histórica')+'" onclick="location=\'informe_conceptos.py?id_conceptos=1\';"  class="menuitem-iconic" image="images/history.png" />\n'
    s=s +  '         </menupopup>\n'
    s=s +  '      </menu>\n'    
    ...
    s=s +  '        <menuitem label="'+_('Operaciones de inversión')+'"  onclick="location=\'mantenimiento_operinversiones.py\';"  class="menuitem-iconic" image="images/history.png" />\n'
