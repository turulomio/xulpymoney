...
def index(req):   
    ...
    req.write('                <rows>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Operación de bolsa de mayor importe:"/>')
    req.write('                        <label value="Fecha" />')
    req.write('                        <label value="Valor" />')
    req.write('                    </row>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Primera operación de usuario:"/>')
    req.write('                        <label value="Mariano Muñoz" />')
    req.write('                        <label value="turulomio@yahoo.es" />')
    req.write('                    </row>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Mayor saldo:"/>')
    req.write('                        <label value="Mariano Muñoz" />')
    req.write('                        <label value="turulomio@yahoo.es" />')
    req.write('                    </row>')
    req.write('                </rows>')
    ...
    req.write('                <rows>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Idea:"/>')
    req.write('                        <label value="Mariano Muñoz" />')
    req.write('                        <label value="turulomio@yahoo.es" />')
    req.write('                    </row>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Desarrollo:"/>')
    req.write('                        <label value="Mariano Muñoz" />')
    req.write('                        <label value="turulomio@yahoo.es" />')
    req.write('                    </row>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Traducción:"/>')
    req.write('                        <label value="Mariano Muñoz" />')
    req.write('                        <label value="turulomio@yahoo.es" />')
    req.write('                    </row>')
    req.write('                </rows>')
    ...
    req.write('                <rows>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Sistema Operativo:"/>')
    ...
    req.write('                    </row>')
    req.write('                    <row>')
    req.write('                        <label id="negrita" value="Database:"/>')
