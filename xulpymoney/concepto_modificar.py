...
def index(req):
    def page():
        ...
        s=s+'            location="mantenimiento_tablas.py";\n'
        s=s+'        }\n'
        s=s+'    }\n'
        ...
        s=s+'    var url="ajax/concepto_modificar.py?id_conceptos="+id_conceptos+"&id_tiposoperaciones="+id_tiposoperaciones+"&concepto="+concepto; \n'
