...
#        q1.start()
        ...
        sql="select isin from products, quotes where quotes.code=products.code and quotes.code like 'MC#%' and isin like 'ES%' and quotes.date='"+yesterday+"' and last<>'close' order by isin;"
