...
function insert(){
    ...
    var url="ajax/inversion_modificar.py?id_inversiones="+<%=id_inversiones %>+"&inversion="+inversion+"&compra="+compra+"&venta="+venta+"&id_cuentas="+id_cuentas+"&tpcvariable="+tpcvariable +"&internet="+internet;
...
<vbox flex="1">
    ...
    <grid align="center">
        ...
        <row><label value="Cambiar el nombre"/><hbox><textbox id="inversion" value="<%=reg['inversion'] %>"/></hbox></row>
        ...
        <row><label value="Nombre de Internet" /><hbox><textbox id="internet" value="<%=reg['internet'] %>"/></hbox></row>        
