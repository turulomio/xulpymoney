...
class Compile(Command):
    ...
    def run(self):
        ...
        download_from_github('turulomio','reusingcode','python/wdgYearMonth.py', 'xulpymoney/ui')
        download_from_github('turulomio','reusingcode','python/package_resources.py', 'xulpymoney')
        download_from_github('turulomio','reusingcode','python/qtablewidgetitems.py', 'xulpymoney/ui')
