...
def menu():
    ...
    s=s +  '      <menu label="Conceptos">\n'
    s=s +  '         <menupopup>\n'
    s=s +  '            <menuitem label="Estudio mensual" onclick="location=\'informe_conceptos_mensual.psp\';"  class="menuitem-iconic" image="images/history.png" />\n'
    s=s +  '            <menuitem label="Evolución histórica" onclick="location=\'informe_conceptos.psp?id_conceptos=1\';"  class="menuitem-iconic" image="images/history.png" />\n'
    s=s +  '         </menupopup>\n'
    s=s +  '      </menu>\n'    
    ...
    s=s +  '        <menuitem label="Tablas auxiliares"  onclick="location=\'mantenimiento_tablas.psp\';" />\n'
    s=s +  '      </menupopup>\n'
    s=s +  '    </menu>\n'    
