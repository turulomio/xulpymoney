...
#    s=s+'"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n'
    ...
    # we don't need anymore, and nextx becomes lastx for the next segment
        s=s+'<rect x="375" y="'+ str(ykey) + '" width="40" height="30" fill="'+colors[i] + '" stroke="black" stroke-width="1"/><text x="425" y="'+str(ykey+20)+'"	style="font-family:verdana, arial, sans-serif;			font-size: 14;			fill: black;			stroke: none">'+n[0]+'</text>\n'
        ykey = ykey + 35
        lastx = nextx
        lasty = nexty
        i += 1
