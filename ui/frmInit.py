...
class frmInit(QDialog, Ui_frmInit):
    ...
    def create_xulpymoney(self):
        ...
        cur.execute("insert into conceptos values(29,'{0}',4,false)".format(self.trUtf8("Purchase product product")))
        cur.execute("insert into conceptos values(35,'{0}',5,false)".format(self.trUtf8("Product product sales")))
